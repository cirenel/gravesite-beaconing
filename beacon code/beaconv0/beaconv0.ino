...
#define LEDPIN 6
#define NUMPIXELS 9
#define DELAYVAL 20 // time in ms for pauses in lightwork 
...
//      xbee.print(curLatH+":"+curLonH+"\n"); //dont need direction, if it is in xbee range it damn well better be in the same hemisphere... wont work on the equator or at the prime meredian 
    } else { //we have a fix and are stable. do we have incoming coms? if so, light up!
